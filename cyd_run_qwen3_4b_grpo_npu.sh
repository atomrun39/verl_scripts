...
trainer_experiment_name='qwen3_4b_grpo_1node'-${TIMESTAMP}
...
TRAIN_FILE=${TRAIN_FILE:-"${RAY_DATA_HOME}/data/dapo-math-17k_dedup_r1_sys_prompt_mathdapo/train.parquet"}
TEST_FILE=${TEST_FILE:-"${RAY_DATA_HOME}/data/dapo-math-17k_dedup_r1_sys_prompt_mathdapo/test.parquet"}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.logger=['console','swablab'] \
